...
# add aliases to running shell. Once in a while, check personal .aliases file and
# bring any generally useful entries back here
# shellcheck source=/home/dave/.aliases
source ~/.aliases
